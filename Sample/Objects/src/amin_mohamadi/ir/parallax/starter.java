...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "amin_mohamadi.ir.parallax", "amin_mohamadi.ir.parallax.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "amin_mohamadi.ir.parallax.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
